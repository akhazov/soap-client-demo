...
@XmlSeeAlso({
    EpguPrivatePersonRequestType.class,
    EpguPrivateEntrepreneurRequestType.class,
    EpguJuridicalPersonRequestType.class,
    EpguForeignCitizenRequestType.class,
    EpguCancelRequestType.class,
    EpguResponseType.class
})
